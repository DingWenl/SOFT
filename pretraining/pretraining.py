...
from data_generator_source import train_datagenerator#, val_datagenerator
...
if __name__ == '__main__':
    ...
    for group_n in range(5):
        ...
        for t_train in t_train_list:
            ...
            model_path = '/data/dwl/ssvep/model/benchmark_transfer/cnnformer_original_train_loss/tt_%3.1fs_02_%d.h5'%(t_train,group_n)
