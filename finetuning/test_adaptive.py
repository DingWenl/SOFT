...
if __name__ == '__main__':
    ...
    # selcting the number of unseen (seen) categories
    n_unseen_list = list(range(5))#[::-1]
    for n_unseen in n_unseen_list:
        
        total_av_acc_list = []
        for group_n in range(5):
            test_subject_list = list(range(group_n*7+1,(group_n+1)*7+1))
            # test_subject_list = [23]
        ...
        # df.to_excel("/home/Dwl/result/soft/benchmark_ft2_original64_cross_unseen_0520_unseen%d.xlsx"%n_unseen, index=False)
